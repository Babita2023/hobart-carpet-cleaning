...
const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await fetch(
        "https://script.google.com/macros/s/AKfycbx_Q12WmxTet_JWLL7eDE1kV_SJJTuYdGvsuLrrFp30qNkOyfZVHE3a2ksa3xat0kYAow/exec",
        {
          method: "POST",
            headers: {
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-primary-foreground opacity-80 text-lg mb-8">
            ...
            <div className="space-y-4">
              ...
              <a href="mailto:bikashchamp9817@gmail.com" className="flex items-center gap-3 text-primary-foreground opacity-90">
                <Mail className="w-5 h-5" /> bikashchamp9817@gmail.com
              </a>
              <div className="flex items-center gap-3 text-primary-foreground opacity-90">
